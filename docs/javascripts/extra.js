...
(function() {
    ...
    class APIEnhancer {
        ...
        setupTryItButtons() {
            ...
            const apiEndpoints = document.querySelectorAll('.highlight .language-http, .highlight .language-bash');
                    ...
                    if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
                        mutation.addedNodes.forEach((node) => {
                            if (node.nodeType === Node.ELEMENT_NODE) {
                                ...
                                const firstFocusable = node.querySelector('a, button, input, textarea, select, [tabindex]:not([tabindex="-1"])');
