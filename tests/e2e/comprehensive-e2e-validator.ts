...
interface StepValidation {
  type: 'element_exists' | 'text_contains' | 'url_contains' | 'api_call' | 'database_state' | 'accessibility';
  target: string;
  expected: any;
  critical: boolean;
}
...
class MediaNestE2EValidator {
    ...
    return {
      ...
      steps: [
        ...
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="password-strength-indicator"]', expected: true, critical: false }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="registration-success"]', expected: true, critical: true },
            { type: 'api_call', target: '/api/auth/register', expected: { status: 201 }, critical: true }
          ]
        },
        {
          ...
          action: 'verify',
          validation: [
            { type: 'element_exists', target: '[data-testid="email-verification-notice"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="verification-success"]', expected: true, critical: true }
          ]
        },
        {
          ...
          target: '/auth/login',
          validation: [
            { type: 'element_exists', target: '[data-testid="login-form"]', expected: true, critical: true }
          ]
        },
        {
        ...
        },
        {
          ...
          validation: [
            ...
            { type: 'element_exists', target: '[data-testid="welcome-message"]', expected: true, critical: true }
          ]
        }
      ]
    };
    ...
    return {
      ...
      steps: [
        ...
        },
        {
          ...
          value: 'test-files/sample-image.jpg,test-files/sample-video.mp4,test-files/sample-audio.mp3',
          validation: [
            { type: 'element_exists', target: '[data-testid="file-preview"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="upload-configuration"]', expected: true, critical: false }
          ]
        },
        {
          name: 'set_metadata',
        ...
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="upload-progress"]', expected: true, critical: true }
          ]
        },
        {
          ...
          timeout: 60000,
          validation: [
            { type: 'element_exists', target: '[data-testid="processing-complete"]', expected: true, critical: true },
            { type: 'api_call', target: '/api/files/status', expected: { status: 'processed' }, critical: true }
          ]
        },
        {
          ...
          target: '/media',
          validation: [
            { type: 'element_exists', target: '[data-testid="uploaded-files"]', expected: true, critical: true },
            { type: 'element_exists', target: '[data-testid="file-thumbnails"]', expected: true, critical: false }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="file-preview-option"]', expected: true, critical: true },
            { type: 'element_exists', target: '[data-testid="file-edit-option"]', expected: true, critical: true },
            { type: 'element_exists', target: '[data-testid="file-share-option"]', expected: true, critical: true }
          ]
        }
      ]
    };
      ...
      steps: [
        {
          ...
          target: '/media',
          validation: [
            { type: 'element_exists', target: '[data-testid="media-library"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="collection-create-modal"]', expected: true, critical: true }
          ]
        },
        {
        ...
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="collection-created-success"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="file-selector-modal"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="selected-files-counter"]', expected: true, critical: false }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="files-added-to-collection"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="media-editor"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="crop-handles"]', expected: true, critical: false }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="edit-success-message"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="share-modal"]', expected: true, critical: true }
          ]
        },
        {
          ...
          validation: [
            { type: 'element_exists', target: '[data-testid="share-link-generated"]', expected: true, critical: true }
          ]
        }
      ]
    };
   ...
   */
  private async executeJourney(page: Page, journey: UserJourney, browserType: string, deviceType: string): Promise<E2ETestResult> {
  ...
  async generateValidationReport(results: E2ETestResult[]): Promise<string> {
    ...
    const performanceIssues = results.filter(r => 
      r.performanceMetrics?.pageLoadTime && r.performanceMetrics.pageLoadTime > 3000
    );
    
    const accessibilityIssues = results.filter(r => 
      r.accessibilityReport?.score && r.accessibilityReport.score < 90
    );
...
${this.generateDetailedResults(results)}
  ...
  private generateRecommendations(results: E2ETestResult[]): string {
    ...
    if (failureRate > 10) {
      recommendations.push('- High failure rate detected - review test stability and application reliability');
    }
    
    const slowTests = results.filter(r => r.performanceMetrics?.pageLoadTime && r.performanceMetrics.pageLoadTime > 5000);
    if (slowTests.length > 0) {
      recommendations.push('- Performance optimization needed - multiple tests show slow load times');
    }
...
export { MediaNestE2EValidator, UserJourney, E2ETestResult, PerformanceMetrics, AccessibilityReport };