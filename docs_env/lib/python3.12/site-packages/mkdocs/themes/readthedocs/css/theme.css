...
.btn {
  ...
  box-shadow: inset 0 1px 2px -1px hsla(0, 0%, 100%, 0.5), inset 0 -2px 0 0 rgba(0, 0, 0, 0.1);
  outline-none: false;
  vertical-align: middle;
  *display: inline;
  zoom: 1;
...
code {
  ...
  font-size: 75%;
  padding: 0 5px;
  font-family: SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, Courier,
    monospace;
  color: #e74c3c;
  overflow-x: auto;
}
