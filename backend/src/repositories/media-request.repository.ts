...
> {
  ...
  // Add missing methods for media controller compatibility
  async count(where: Prisma.MediaRequestWhereInput = {}): Promise<number> {
    try {
  ...
  async findMany(
    options: PaginationOptions & { where?: Prisma.MediaRequestWhereInput } = {},
