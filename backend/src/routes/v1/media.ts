...
// PUT /api/media/requests/:requestId - Update request status
router.put(
  '/requests/:requestId',
  validate(updateRequestSchema),
  asyncHandler(mediaController.updateRequest),
);

// GET /api/media/requests/:requestId/status - Get request status tracking
router.get(
  '/requests/:requestId/status',
  validate(requestStatusSchema, 'params'),
  asyncHandler(mediaController.getRequestStatus),
);
