...
router.get('/:mediaType/:tmdbId', 
  asyncHandler(mediaController.getMediaDetails)
);

// POST /api/media/request - Submit media request
router.post('/request', 
  validate(mediaRequestSchema),
  asyncHandler(mediaController.requestMedia)
);

// GET /api/media/requests - Get user's requests
router.get('/requests', 
  asyncHandler(mediaController.getUserRequests)
);

// GET /api/media/requests/:requestId - Get specific request details
router.get('/requests/:requestId', 
  asyncHandler(mediaController.getRequestDetails)
);

// DELETE /api/media/requests/:requestId - Delete a pending request
router.delete('/requests/:requestId', 
  asyncHandler(mediaController.deleteRequest)
);
