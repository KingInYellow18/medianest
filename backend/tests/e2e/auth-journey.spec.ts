...
test.describe('Authentication User Journey', () => {
  ...
  test('should complete successful Plex OAuth login flow', async () => {
    ...
    await expect(page.locator('[data-testid="welcome-message"]')).toContainText('Welcome to MediaNest');
    ...
    await expect(page.locator('[data-testid="plex-instructions"]')).toContainText('Enter the 4-digit PIN');
