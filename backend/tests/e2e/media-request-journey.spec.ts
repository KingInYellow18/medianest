...
test.describe('Media Request User Journey', () => {
  ...
  test('should create media request successfully', async () => {
    ...
    await expect(page.locator('[data-testid="success-notification"]')).toContainText('Request created successfully');
  ...
  test('should handle request status updates', async () => {
    ...
    await expect(requestItem.locator('[data-testid="admin-note"]')).toContainText('Approved by admin');
  });
  ...
  test('should cancel pending request', async () => {
    ...
    // Verify success notification
    await expect(page.locator('[data-testid="success-notification"]')).toContainText('Request cancelled successfully');
  });
  ...
  test.describe('Admin Request Management', () => {
    ...
    test('should reject request with reason', async () => {
      ...
      // Verify success
      await expect(page.locator('[data-testid="success-notification"]')).toContainText('Request rejected');
    });
  });
  ...
  test.describe('Error Handling', () => {
    test('should handle search API errors gracefully', async () => {
      ...
      await expect(page.locator('[data-testid="error-notification"]')).toContainText('Search failed');
    ...
    test('should handle request creation errors', async () => {
      ...
      // Verify error handling
      await expect(page.locator('[data-testid="error-notification"]')).toBeVisible();
      await expect(page.locator('[data-testid="error-notification"]')).toContainText('already requested');
    });
  });
