...
test.describe('Plex Integration User Journey', () => {
  ...
  test('should display Plex server information', async () => {
    ...
    await expect(page.locator('[data-testid="server-name"]')).toContainText('MediaNest Plex Server');
  ...
  test('should view movie details and metadata', async () => {
    ...
    await expect(page.locator('[data-testid="detail-summary"]')).toContainText('A thief who steals corporate secrets');
  ...
  test('should browse TV show library and episodes', async () => {
    ...
    await expect(breakingBadItem.locator('[data-testid="media-title"]')).toContainText('Breaking Bad');
    ...
    await expect(breakingBadItem.locator('[data-testid="season-count"]')).toContainText('5 seasons');
    await expect(breakingBadItem.locator('[data-testid="episode-count"]')).toContainText('62 episodes');
  });
  ...
  test('should display recently added content', async () => {
    ...
    await expect(secondRecent.locator('[data-testid="media-title"]')).toContainText('The Dark Knight');
  ...
  test('should handle Plex server connectivity issues', async () => {
    ...
    await expect(page.locator('[data-testid="server-error"]')).toContainText('Plex server unreachable');
  ...
  test('should handle library loading errors', async () => {
    ...
    await expect(page.locator('[data-testid="library-error"]')).toContainText('Library scan in progress');
