...
test.describe('YouTube Download User Journey', () => {
  ...
  test('should extract video metadata successfully', async () => {
    ...
    await expect(page.locator('[data-testid="video-title"]')).toContainText('Rick Astley - Never Gonna Give You Up');
    ...
    await expect(page.locator('[data-testid="video-thumbnail"]')).toHaveAttribute('src', /maxresdefault/);
    
    // Verify description
    await expect(page.locator('[data-testid="video-description"]')).toContainText('The official video');
  });
  ...
  test('should display format selection options', async () => {
    ...
    await expect(page.locator('[data-testid="format-title"]')).toContainText('Choose Quality & Format');
    ...
    await expect(video1080p.locator('[data-testid="format-resolution"]')).toContainText('1920x1080');
  ...
  test('should start download successfully', async () => {
    ...
    await expect(page.locator('[data-testid="success-notification"]')).toContainText('Download started successfully');
  ...
  test('should display download history and status', async () => {
    ...
    await expect(completedDownload.locator('[data-testid="download-title"]')).toContainText('Rick Astley');
    await expect(completedDownload.locator('[data-testid="download-status"]')).toContainText('Completed');
    await expect(completedDownload.locator('[data-testid="download-progress"]')).toContainText('100%');
    await expect(completedDownload.locator('[data-testid="download-size"]')).toContainText('22.4 MB');
    await expect(completedDownload.locator('[data-testid="download-quality"]')).toContainText('720p');
    ...
    await expect(activeDownload.locator('[data-testid="download-title"]')).toContainText('Another Video Title');
    await expect(activeDownload.locator('[data-testid="download-status"]')).toContainText('Downloading');
    await expect(activeDownload.locator('[data-testid="download-progress"]')).toContainText('45%');
    await expect(activeDownload.locator('[data-testid="progress-bar"]')).toHaveAttribute('value', '45');
    await expect(activeDownload.locator('[data-testid="download-speed"]')).toContainText('1.0 MB/s');
    ...
    await expect(failedDownload.locator('[data-testid="download-title"]')).toContainText('Failed Download Video');
    await expect(failedDownload.locator('[data-testid="download-status"]')).toContainText('Failed');
    await expect(failedDownload.locator('[data-testid="error-message"]')).toContainText('Video no longer available');
  ...
  test('should cancel active download', async () => {
    ...
    await expect(page.locator('[data-testid="cancel-message"]')).toContainText('Are you sure you want to cancel this download?');
    await page.click('[data-testid="confirm-cancel"]');
    
    // Verify success notification
    await expect(page.locator('[data-testid="success-notification"]')).toBeVisible();
    await expect(page.locator('[data-testid="success-notification"]')).toContainText('Download cancelled successfully');
  });
  ...
  test('should retry failed download', async () => {
    ...
    // Verify success notification
    await expect(page.locator('[data-testid="success-notification"]')).toBeVisible();
    await expect(page.locator('[data-testid="success-notification"]')).toContainText('Download retry started');
  });
  ...
  test('should handle rate limiting', async () => {
    ...
    await expect(page.locator('[data-testid="error-notification"]')).toContainText('Rate limit exceeded');
    await expect(page.locator('[data-testid="error-notification"]')).toContainText('5 downloads per hour');
  ...
  test('should handle invalid video URLs gracefully', async () => {
    ...
    await expect(page.locator('[data-testid="error-notification"]')).toBeVisible();
    await expect(page.locator('[data-testid="error-notification"]')).toContainText('Video not found');
