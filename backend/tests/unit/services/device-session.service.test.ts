...
describe('DeviceSessionService', () => {
  ...
  describe('updateSessionActivity', () => {
    ...
    it('should handle non-existent session', async () => {
      ...
      await expect(service.updateSessionActivity('nonexistent')).rejects.toThrow('Record not found');
    });
  });
  ...
  describe('revokeSession', () => {
    ...
    it('should handle unauthorized revocation attempt', async () => {
      ...
      await expect(service.revokeSession('session-123', 'wrong-user')).rejects.toThrow('Record not found');
    });
  });
