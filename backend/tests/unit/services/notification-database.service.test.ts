...
describe('NotificationDatabaseService', () => {
  ...
  describe('markNotificationAsRead', () => {
    ...
    it('should handle non-existent notification', async () => {
      ...
      await expect(
        service.markNotificationAsRead('nonexistent', 'user-123')
  ...
  describe('markAllNotificationsAsRead', () => {
    ...
    it('should handle database errors', async () => {
      ...
      await expect(service.markAllNotificationsAsRead('user-123')).rejects.toThrow('Database error');
    });
  });
  ...
  describe('deleteNotification', () => {
    ...
    it('should handle non-existent notification', async () => {
      ...
      await expect(
        service.deleteNotification('nonexistent', 'user-123')
      ).rejects.toThrow('Record not found');
    });
  });
  ...
  describe('createBulkNotifications', () => {
    ...
    it('should handle transaction failures', async () => {
      ...
      await expect(service.createBulkNotifications(notifications)).rejects.toThrow('Transaction failed');
    });
  });
  ...
  describe('getNotificationsByType', () => {
    ...
    it('should handle database errors', async () => {
      ...
      await expect(
        service.getNotificationsByType('user-123', 'REQUEST_APPROVED')
