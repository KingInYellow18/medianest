...
describe('YoutubeService', () => {
  ...
  describe('getVideoInfo', () => {
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(service.getVideoInfo(videoId)).rejects.toThrow('Failed to fetch video information');
    });
    ...
    it('should handle rate limiting', async () => {
      ...
      await expect(service.getVideoInfo(videoId)).rejects.toThrow('Rate limit exceeded. Please try again later.');
    });
  });
  ...
  describe('createDownloadRequest', () => {
    ...
    it('should validate video URL', async () => {
      ...
      await expect(service.createDownloadRequest(requestData)).rejects.toThrow('Invalid YouTube URL');
    });
  ...
  describe('updateDownloadProgress', () => {
    ...
    it('should validate progress range', async () => {
      ...
      await expect(
        service.updateDownloadProgress(downloadId, invalidProgress)
  ...
  describe('deleteDownload', () => {
    ...
    it('should handle unauthorized deletion', async () => {
      ...
      await expect(service.deleteDownload('download-123', 'wrong-user')).rejects.toThrow('Record not found');
    });
  });
  ...
  describe('cancelDownload', () => {
    ...
    it('should handle unauthorized cancellation', async () => {
      ...
      await expect(service.cancelDownload('download-123', 'wrong-user')).rejects.toThrow('Record not found');
    });
  });
