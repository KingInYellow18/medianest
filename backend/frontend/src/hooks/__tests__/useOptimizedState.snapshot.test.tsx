  ...
  return (
    <div data-testid='state-component'>
      ...
      <div className='state-controls'>
        <button data-testid='increment-btn' onClick={() => setState((prev: number) => prev + 1)}>
          Increment
        </button>
        <button data-testid='set-object-btn' onClick={() => setState({ name: 'Test', count: 42 })}>
          Set Object
        </button>
        <button data-testid='reset-btn' onClick={meta.reset}>
          Reset
        </button>
      </div>
    </div>
  ...
  return (
    <div data-testid='async-state-component'>
      ...
      <div className='async-controls'>
        <button data-testid='execute-btn' onClick={() => execute()}>
          Execute
        </button>
        <button
        ...
        <button data-testid='reset-async-btn' onClick={reset}>
          Reset
        </button>
      </div>
    </div>
  ...
  return (
    <div data-testid='debounced-state-component'>
      ...
      <div className='debounced-controls'>
        ...
        />
        <button data-testid='set-quick-btn' onClick={() => setValue('quick change')}>
          Quick Change
        </button>
        <button
  ...
  return (
    <div data-testid='combined-state-component'>
      ...
      <div className='async-section'>
        ...
        <button onClick={() => execute(async () => ({ result: 'Combined async result' }))}>
          Load Data
        </button>
      </div>
    </div>
