...
class MediaRequestService {
  constructor(private overseerrService: OverseerrService, private plexService: PlexService) {}
...
class CacheManager {
  constructor(private redis: Redis, private memoryCache: NodeCache) {}
...
class MediaService {
  constructor(private mediaRepo: MediaRepository, private cache: CacheManager) {}
