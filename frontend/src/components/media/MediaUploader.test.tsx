...
describe('MediaUploader Component', () => {
  ...
  it('renders MediaUploader component with default props', () => {
    ...
    expect(screen.getByText('⚠️ MediaUploader - Under Development').closest('.component-stub')).toBeInTheDocument();
  ...
  it('has correct CSS class for styling', () => {
    ...
    const uploader = screen.getByText('⚠️ MediaUploader - Under Development').closest('.component-stub');
